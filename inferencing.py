...
from guj_model.step2_Phonological_revised import Phonological_revised
...
wav_lab_dir = 'test_data/'
tgt_dir = 'test_data/'
feat_dir = 'test_data/posterior_probs/'
...
printheaders = ['textgrid.file',
                ...
                'spread_glottis.actual', 'spread_glottis.postprob']
